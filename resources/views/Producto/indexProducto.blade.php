...
<x-slot name="header">
    <h6 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
        <button class="bg-slate-500 hover:bg-slate-700 text-white py-2 px-4 mx-10 rounded"><a href="{{ route('productos.create') }}">Crear Producto</a></button>
    </h6>
    </x-slot>
                    ...
                    <table class="min-w-full text-left text-sm font-light">
                        ...
                        @foreach ($productos as $producto)
                            ...
                            <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
                                ...
                                </svg>  <a href ="{{ route('productos.edit', $producto)}}">Editar</button>
                                </td>
